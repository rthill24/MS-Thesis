...
dbname_list = []
for i in range(1,9):
    name = "C:/Users/rthill/Documents/MS-Thesis/Midship Section Optimization/Static FOS/Case " + str(i) + "/SD_Midship_Section_Optimizer_Output_Case_" + str(i)
...
plt.legend()
plt.title('Pareto Fronts for All Static FOS Cases')
plt.savefig('All_Static_FOS_Cases_Pareto_Fronts.png', dpi=144)
plt.show()
