...
class SD_Midship_Section_Test_Case(nsga2.Problem):
    ...
    def constraint(self, individual_instance, metamodel=None):
        ...
        HG_FOS_R = 0.75 #required FOS against hull girder collapse
        ...
        panel_FOS_R = 0.9 #required FOS against panel collapse
        ...
        plating_FOS_R = 0.8 #required FOS against plating collapse
...
opt.run("SD_Midship_Section_Optimizer_Output_Case_7", "initial_test", 48109, 200, 500)
