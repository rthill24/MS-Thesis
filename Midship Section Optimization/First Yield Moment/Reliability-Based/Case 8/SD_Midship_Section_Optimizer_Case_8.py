...
class SD_Midship_Section_Test_Case(nsga2.Problem):
    ...
    def constraint(self, individual_instance, metamodel=None):
        ...
        HG_beta_R = 2.5 #required beta against hull girder collapse
        ...
        panel_beta_R = 2.25 #required beta against panel collapse
        ...
        plating_beta_R = 1.75 #required beta against plating collapse
...
opt.run("SD_Midship_Section_Optimizer_Output_Case_8", "initial_test", 48109, 200, 500)
