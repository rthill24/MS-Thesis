...
#cycle through SC return to optimality cases
for i in range(1,9):
    name = "C:/Users/rthill/Documents/MS-Thesis/Midship Section Optimization/Smith Collapse/Reliability-Based/Case " + str(i) + "/SD_Midship_Section_Optimizer_Output_Case_" + str(i)
...
ax = plt.gca()
legend1 = ax.legend(handles=group_handles, loc='upper right', title='Class Type')
...
plt.savefig('SC_RBRTO_vs_SC_RB_Paper.png', dpi=144, bbox_inches='tight')
plt.show()
