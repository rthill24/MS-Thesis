...
class Box_Test_Case(nsga2.Problem):
    ...
    def constraint(self, individual_instance, metamodel=None):
        ...
        SM = data2[5]
        SM_R = 0.010612068900226665 #section modulus of reference box from "Box Test Case.py"
        frac_SM = (SM_R-SM)/SM_R

        #evaluate My
        My = data2[6]
        My_R = 2.19669826234692 #My of reference box from "Box Test Case.py"
        ...
        constraints_empty = [0, 0, 0, 0, 0, 0, 0]
...
test_problem = Box_Test_Case(2, 7, 6, [1,0.001,1,0.001,1,0.001], [8,0.012,8,0.012,8,0.012])
opt = nsga2.Optimizer(test_problem)
opt.run("Box_Optimizer_Output", "initial_test", 48109, 100, 100)