...
class Midship_Section(object):
    ...
    def section_data(self, mirror = False): #"mirror" will double the calculations for a symmetric section
        '''
    ...
    def production_cost(self, mirror = False): #mirror will double the calculations for a symmetric section
        '''
    ...
    def HG_stress (self, M_tot = 46589 , mirror = False): #M_tot is the total moment in the midship section in kN*m
        '''
    ...
    def HG_FOS (self, My, M_tot = 46589, mirror = False): #M_tot is the total moment in the midship section in kN*m
        '''
    ...
    def plot_section(self, show=False, mirror=False, ax_obj=None): #mirror is used to mirror the plot, does not automatically mirror calculations
        '''Plots the section'''
